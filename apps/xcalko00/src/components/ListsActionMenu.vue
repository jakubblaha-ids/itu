...
<template>
    ...
    <div class="bg-primary flex flex-row justify-around shadow p-1">
    ...
    <div class="flex flex-row justify-between bg-secondary shadow py-2 rounded-b mt-1">
        ...
        <div class="flex flex-row ">
            <p class="pr-1 font-light" v-if="sortOrder == 'Category'">{{ 'Sort options' }}</p>
            <svg  v-if="sortOrder == 'Category'" class="mt-1 w-4 h-4 cursor-pointer" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" data-slot="icon">
