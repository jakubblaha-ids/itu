...
<div onclick={() => console.log("TODO")} class="bg-gray h-44 w-full p-4 rounded-2xl flex flex-col overflow-y-auto z-0">
    <div class="flex flex-col gap-1">
        <div class="flex items-center flex-wrap gap-2">
            ...
            <button onclick={copyListCode} class='relative bg-white grid place-items-center h-10 w-10 rounded-full text-gray z-10 button'>
